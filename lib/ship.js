...
// if Asteroids === undefined = {}
  ...
  Ship.prototype.collideCalc = function (asteroid) {
    ...
    if (this.distance(asteroid.pos) < (48 + asteroid.radius)) {
    ...
    // var dx = asteroid.pos[0] - this.pos[0];
    // var dy = this.pos[1] - asteroid.pos[1];
    //
    // var asteroidAngle = Math.atan( dy/dx );
    // // console.log("dy: " + dy + " " + "dx: " + dx);
    //
    // if ((dy >= 0) && (dx < 0)) {
    //   asteroidAngle = Math.PI + asteroidAngle;
    // }
    // if ((dy < 0) && (dx <= 0)) {
    //   asteroidAngle = Math.PI + asteroidAngle;
    // }
    // if ((dy < 0) && (dx > 0)) {
    //   asteroidAngle = 2*Math.PI + asteroidAngle
    // }
    //
    // console.log(this.angle*180/Math.PI)
    // var shipAngle;
    // if(this.angle <= 0) {
    //   console.log("ship: " + (Math.abs(this.angle)%(2*Math.PI)) * 180/Math.PI);
    //   shipAngle = (Math.abs(this.angle)%(2*Math.PI)) * 180/Math.PI
    // }
    // if(this.angle > 0) {
    //   console.log("ship: " + (Math.abs(2* Math.PI - (this.angle%(2*Math.PI)))) * 180/Math.PI);
    //   shipAngle = Math.abs(2* Math.PI - (this.angle%(2*Math.PI))) * 180/Math.PI;
    // }
    // console.log("asteroidAngle: " + (asteroidAngle * 180/Math.PI));
    // var dist = 24 * Math.sin(this.triAngle)/Math.sin(Math.PI - ((asteroidAngle - shipAngle) + this.triAngle));
    // console.log(dist);
